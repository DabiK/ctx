...
- [ ] #2 — Bootstrap CLI, init, prompt and doctor (labels: ready-for-agent)
  ...
  **Issue #2 — détail complet**
  ...
  >
  > Establish the TypeScript/Node command application seam and platform-port boundaries needed by later slices. Keep the product name, executable name, request marker, response marker, and generated config names derived from one build-time branding source.
  >
  > ## Acceptance criteria
  >
...
- [ ] #9 — Yolo user mode and notifications (labels: ready-for-agent)
