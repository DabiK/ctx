...
- The highest testing seam is a command application service with injected repository, filesystem, clipboard, terminal, notification, and clock ports. The parser, executor, and TUI call this seam rather than shelling through one another.
